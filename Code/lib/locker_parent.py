...
class LockerParent:
    ...
    def __del__(self):
        ...
        if self.spreadsheet:
            ...
            if self.spreadsheet.updated:
                self.upload_database()
        if self.fs_server_handler and self.fs_server_handler.sftp:
    ...
    def upload_database(self):
        ...
        if self.spreadsheet and self.fs_server_handler:
